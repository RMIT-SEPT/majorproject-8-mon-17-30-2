...
public class BookingServiceTest {
	...
	public void init() {
		...
		bookingSlotTest = new BookingSlot(LocalDate.of(2020, 12, 20), LocalTime.of(5, 30), LocalTime.of(12, 30),
				serviceList);
		...
		bookingTestBlueprint = new BookingBlueprint(customerTest.getId(), workerTest.getId(), businessTest.getId(),
				bookingSlotTest.getId(), serviceTest.getId());
